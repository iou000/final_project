...
<!-- Google analytics -->
<script type="text/javascript" src="//image.hmall.com/p/js/co/GoogleAnalyticsBuilder.js?ver=050417"></script>
<script type="text/javascript" src="//image.hmall.com/p/js/co/ScreenNameObj.js?ver=050417"></script>
...
function setOnAirSkySc(){
	try {
		$.ajax({
	        type: "get"
	        ,url: "https://wwwca.hmall.com/p/coe/onAirList.do?time=050417"
	        ,dataType: "html"
	        ,async: true
	        ,success : function(data) {
	      ...
	      ,error : function(e) {
	    	  ...
	    	  $.ajax({
	              type: "get"
	              ,url: "/p/coe/onAirList.do?time=050417"
	              ,dataType: "html"
	              ,async: true
	              ,success : function(data) {
	                 $('#skyScOnAirArea').append(data);
...
function setCardPromotion() {
    try {
        $.ajax({
            type: "get"
            ,url: "https://wwwca.hmall.com/p/coe/onAirCardPrmoList.do?time=050417"
            ,dataType: "html"
            ,async: true
            ,success : function(data) {
            ...
            ,error : function(e) {
            	...
            	$.ajax({
                    type: "get"
                    ,url: "/p/coe/onAirCardPrmoList.do?time=050417"
                    ,dataType: "html"
                    ,async: true
                    ,success : function(data) {
                       $('#skyScCardArea').append(data);
