    ...
    <div class="footer-contents">
        ...
        <div class="info-area">
            ...
            <div class="footer-info">
                <!--<button class="btn-footer" data-modules-customtoggle="parent:.footer-info;activeClass:on;"><strong>(주)흰디검은디</strong></button>-->

                <div class="hmall-info">
                    <div class="list-contents">
                        <p><span>대표이사 : 흰디검은디</span><span>주소 : 서울특별시 우리구 우리길 00 (주)우리집</span></p>
                        <p><span>사업자등록번호 : 123-12-12345</span><span>통신판매업 신고 : 제 00-1234호</span></p>
                        <p><span>고객센터 TEL : 1234-1234(유료)</span><span>COPYLEFT : @ 2022 devsacti ALL RIGHTS RESERVED</span></p>
                    </div>
                </div>
                <!-- // .hamall-info -->
