                    ...
                    <div class="cus-wrap noti">
                      <!--공지사항-->
                            ...
                            <div class="tblwrap tbl-list">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="nowrap"><a
                                                    href="/p/ccb/noticeView.do?ancmId=53722&page=1">개인정보처리방침 변경
                                                    안내(01/27)</a></td>
                        ...
                        <div class="question-wrap">
                            <h3>1:1 문의하기</h3>
                            <div class="btngroup">
                                <button class="btn btn-chat" type="button" onclick="openCnslChat();"><span><i
                                            class="icon"></i>1:1 문의하기 </span></button>
                                <button class="btn btn-board" onclick="openCnslAcptPup(); return false;"><span><i
                                            class="icon"></i>내 상담내역 조회</span></button>
                    ...
                    <div class="cus-wrap">
                        ...
                        <div class="accparent">
                            ...
                            <div class="accordion-panel best-txt01" role="best-txt01"
                                aria-label="주문 내용 변경, 취소, AS 등은 어떻게 하나요?">
                                <div class="txt-wrap">
                                    <p>
                                        <strong>
                                            <span style="COLOR: #cc3d3d">
                                                <span
                                        ...
                                        <span style="COLOR: #000000"><span
                                            ...
                                            진행상태에 따라 신청 가능한 항목은 다음과 같습니다.</span>
                                    </p>
                                    <p>&nbsp;</p>
                                    <p>&nbsp;</p>
                            ...
                            <div class="accordion-panel best-txt02" role="best-txt02"
                                aria-label="주문한 상품은 배송 내역은 어디서 확인하나요?">
                                <div class="txt-wrap">
                            ...
                            <div class="accordion-panel best-txt03" role="best-txt03"
                                aria-label="취소/반품 완료 후 환불 언제 되나요?">
                                <div class="txt-wrap">
                            ...
                            <div class="accordion-panel best-txt04" role="best-txt04"
                                aria-label="택배기사를 기다릴 필요없이 편의점반품이 가능한가요?">
                                <div class="txt-wrap">
                                    <span
                            ...
                            <div class="accordion-panel best-txt07" role="best-txt07"
                                aria-label="교환 또는 반품이 안되는 경우는 어떤 경우인가요?">
                                <div class="txt-wrap">
                                    <p style="LINE-HEIGHT: 1.5"><span
                            ...
                            <div class="accordion-panel best-txt09" role="best-txt09"
                                aria-label="백화점 상품의 배송은 어떻게 진행이 되나요?">
                                <div class="txt-wrap">
                            ...
                            <div class="accordion-panel best-txt010" role="best-txt010"
                                aria-label="주문 후 배송상태를 어떻게 알 수 있나요?">
                                <div class="txt-wrap">
                                    <p style="LINE-HEIGHT: 1.5"><span style="COLOR: #000000"><span
