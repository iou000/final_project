										...
										<c:forEach items="${productBoardDTO}" var="list">
											...
											<li class="pdthumb">
												...
												<a href="${app}/p/${list.prd_board_id}">
													<div class="thumb">
														<img
															src="https://image.hmall.com/static/7/7/32/41/2141327733_0.jpg?RS=300x300&amp;AR=0"
															alt="로에베 에센시아 로에베 옴므 데오도란트 스틱 75ml/2.5oz"
															id="2141327733_img"
													...
													<div class="figcaption">
														...
														<div class="pdinfo"><div class="benefits" style="line-height: 20px;"><span>현대7%</span></div><p class="like-count">1</p></div>
													</div>
											</a>
											<a href="#" onclick="" class="hoverview"><i class="icon"></i>새창열기</a>
											<div class="alimlike" data-slitmcd="2141048469" data-bsitmcd="2141048469"><a href="#" class="btn btn-like" onclick=""><i class="icon"></i><span class="hiding">찜</span></a></div>
											</li>
											<!-- 상품 끝 -->
										</c:forEach>
									</ul>
