		...
		<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
			<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
				...
				<form id="searchForm" name="searchForm" action="/p/mpa/selectOrdDlvCrst" method="get">
					<input type='hidden' name='searchType' id='searchType' value="2" /> <input type='hidden'
						name='ordStrtDt' id='ordStrtDt' value="" /> <input type='hidden' name='ordEndDt' id='ordEndDt'
						value="" /> <input type='hidden' name='selectTypeGbcd' id='selectTypeGbcd' value="" /> <input
						type='hidden' name='itemNm' id='itemNm' value="" /> <input type='hidden' name='listSize'
						id='listSize' value="" /> <input type='hidden' name='selectListSize' id='selectListSize'
						value="" /> <input type='hidden' name='pageType' id='pageType' value="ALL" />
				</form>
							...
							<dl>
								...
								<dd class="btn-col2">
									...
									<div class="btngroup">
										...
										<buton class="btn btn-linelgray small30" type="button"
