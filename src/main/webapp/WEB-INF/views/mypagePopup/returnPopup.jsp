    ...
    <div class="popup-win wd540 review-write">
        <div class="pop-wrap" tabindex="0">
            ...
            <div class="pop-content-wrap">
                <strong class="pop-title">반품 사유</strong>
                <!--pop-content-->
                <div class="pop-content">
                    <div class="content">
                        ...
                        <div class="bg-gray-box">
                         ...
                         <form name ="updateflagR"  id="updateflagR" action="${app}/mypage/flagUpdateR" method="post">
                         	<input type = "hidden" name = "prd_orderdetail_id" value="${list[0].prd_orderdetail_id}"/>
						 	<input type = "hidden" name = "order_flag" value="RSTEP1"/>
 						 </form>
                        <div class="btngroup">
